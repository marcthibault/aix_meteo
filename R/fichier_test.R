...
# Simuler sï¿½rie temp, test
# serietemp <- ts(data = rt(250, df = 10), start = 1, frequency = 1)
# plot(serietemp, ylim = c(-5,5), main ="Rï¿½alisations de variables alï¿½atoires iid de loi de Student a 10 degres de libertï¿½")
...
# On va travailler sur la sï¿½rie teporelle des tempï¿½ratures
